package cn.fashi.middleware.dynamic.thread.pool.sdk.config;

import cn.fashi.middleware.dynamic.thread.pool.sdk.domain.DynamicThreadPoolService;
...
import cn.fashi.middleware.dynamic.thread.pool.sdk.domain.model.valobj.RegistryEnumVO;
import cn.fashi.middleware.dynamic.thread.pool.sdk.registry.IRegistry;
import cn.fashi.middleware.dynamic.thread.pool.sdk.registry.redis.RedisRegistry;
import cn.fashi.middleware.dynamic.thread.pool.sdk.trigger.job.ThreadPoolDataReportJob;
import cn.fashi.middleware.dynamic.thread.pool.sdk.trigger.listener.ThreadPoolConfigAdjustListener;
 ...
 */
@Configuration
@EnableConfigurationProperties(DynamicThreadPoolAutoProperties.class)  // 为了能够使用传入的这个类的属性
@EnableScheduling
public class DynamicThreadPoolAutoConfig {
    ...
    // 通用的创建Redis客户端，用于连接Redis服务器，并进行交互
